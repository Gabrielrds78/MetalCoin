  ...
  <body>
    <div class="cadastro">
        ...
        <div>
          ...
          <input style="top: 317px;" class="input1" type="text" name="dt_nascimento">
        </div>
        <br>
        <div>
        ...
        <div>
          ...
          <input style="top: 481px" class="input1" type="text" name="email">
        </div>
        <br>
        <div>
          <label style="top: 522px" class="nome" for="inputEmail">Login</label>
          <input style="top: 563px" class="input1" type="email" name="login">
        </div>
        <br>
        ...
        <br>
        <div>
          <a class="ja_tenho" href="">Já tenho uma conta</a>
        </div>
